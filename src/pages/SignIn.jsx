    ...
    <section id="signin" className="h-screen-minus-navbar bg-slate-300 flex items-center justify-center">
      <form onSubmit={handleSignIn} action="" className="px-12 py-16 sencond-bg-color rounded-md drop-shadow-lg">
        ...
        <div className="relative">
          ...
          <input type={showPassword ? "text" : "password"} placeholder="Password" onChange={(e) => setPassword(e.target.value)} value={password} className="block w-full p-2 my-4 rounded-md drop-shadow-md focus:outline-none" />
          <button
            type="button"
